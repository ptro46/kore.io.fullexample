...
int		json_to_bo_store(struct kore_json* p_json, ps_bo_store p_bo_store, struct kore_buf* p_kore_buf_errors) {
	int ret = 1 ;
...
// return 0 if error
int		bo_store_to_json_buffer(ps_bo_store p_bo_store, struct kore_buf* p_kore_buf, struct kore_buf* p_kore_buf_errors) {
	int ret = 1 ;
